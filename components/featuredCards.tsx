              ...
              >
                ...
                <div className="flex flex-col justify-start items-start gap-[6px] w-full px-4 py-6 pt-2">
                  ...
                  <div className="flex md:flex-col xl:flex-row justify-between md:justify-center xl:justify-between xl:items-center gap-2 w-full">
                    ...
                    <button className="text-[16px] text-[#997658] outline-none border-[1px] border-[#997658] p-2 md:p-3 font-urbanist rounded-4xl px-4 md:px-7 transition-all duration-300 hover:bg-[#997658] hover:text-[#ffffff] cursor-pointer">
                      Book Now
                    </button>
                  </div>
                </div>
