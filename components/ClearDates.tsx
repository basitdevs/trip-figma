...
const ClearDates: React.FC = () => {
  return (
    <div className="w-full flex justify-start items-start px-3 md:px-12 xl:px-16 py-4">
      <div className="w-full md:max-w-[60%] flex flex-col justify-start items-start gap-2">
        <motion.div
