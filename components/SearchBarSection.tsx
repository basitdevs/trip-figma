...
const SearchBarSection: React.FC = () => {
  return (
    <div className="w-full absolute -bottom-[130px] sm:-bottom-16 md:-bottom-10 left-1/2 transform -translate-x-1/2       ">
      <FadeUp>
              ...
              return (
                ...
                >
                  ...
                  <div className="p-2 px-3 rounded-4xl flex justify-start items-center border-[1px] border-[#3A3A3A] gap-2 w-full">
                    ...
                    />
                    <span className="text-[#3A3A3A] text-[11px] sm:text-[14px] font-urbanist ">
                      {item.value}
                    </span>
                  </div>
                </div>
