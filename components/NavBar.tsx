...
const NavBar: React.FC = () => {
  ...
  return (
    <div className="w-full mx-auto relative">
      <FadeDown>
        <div className="max-w-[88vw] md:max-w-[86vw] mx-auto py-[30px] flex justify-between items-center gap-2 lg:gap-4">
      ...
      <div
        className={`${
          mobileNav
            ? "fixed top-[25px] md:top-[30px]"
            : "fixed top-[-100px] md:top-[-70px]"
        }  z-[100] left-1/2 transform -translate-x-1/2 w-full max-w-[80%]  md:max-w-[500px]  rounded-4xl bg-[#836448] p-3 text-[18px] px-8 text-[#ffffff] lg:hidden transition-all duration-300`}
      >
