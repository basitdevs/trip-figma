    ...
    <div className="flex flex-col gap-6 justify-center items-center w-full mt-4">
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
        {viewers.map((view: Viewer, i: number) => (
          <FadeUp key={i} delay={0.04 * 1}>
            <div className="w-full p-5 cursor-pointer rounded-xl flex flex-col gap-2 bg-[#ffffff] shadow-lg shadow-gray-200 hover:scale-[1.03] transition-all duration-300 ">
      ...
      <FadeUp>
        <button className="text-[#997658] text-[18px] font-normal .font-firtree text-center p-3 px-7 rounded-4xl border-[1px] border-[#997658] hover:text-[#ffffff] hover:bg-[#997658] transition-all duration-300 cursor-pointer mt-5 mb-[4px]">
          Show All Reviews
        </button>
      </FadeUp>
      <hr
