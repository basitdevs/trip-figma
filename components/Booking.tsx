...
const Booking: React.FC = () => {
  return (
    <div className="w-full flex flex-col gap-4 ">
      <FadeUp>
        <div className="w-full flex flex-col gap-3 rounded-3xl bg-[#ffffff] shadow-lg shadow-gray-200 p-4 py-6">
            ...
            <div className="w-full rounded-4xl p-3 flex justify-between items-center gap-2 border-[1px] border-[rgba(35,35,35,0.7)]">
              <div className="flex justify-start gap-2 items-center w-full">
                <Image
                  ...
                  className="w-4"
                />
                <span className="text-[16px] font-normal font-urbanist">
                  04
                </span>
              </div>
          ...
          <div className="w-full flex justify-between items-center gap-3 mx-1">
            ...
            <span className="font-urbanist text-[13px] sm:text-[14px] text-[#3A3A3A]">
              $5
            </span>
          </div>
      ...
      <FadeUp>
        <div className=" border-[1px] border-[#3A3A3A] rounded-2xl p-2 px-6 flex items-center gap-2  mt-1">
          <Image
